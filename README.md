...
프로젝트 진행 중 인력 이탈(퇴사 등) 발생, 인수인계가 충분하지 않아 프로젝트 히스토리 단절, 기존 문서만으로는 의사결정 과정과 기술적 맥락을 이해하기 어려움 <br>
그래서 <br>
"프로젝트의 히스토리를 이해하는 AI가 있다면 어떨까?" <br>
"더 나아가서 프로젝트 진행 상황을 보고 리스크를 예측해주는 AI가 있다면 어떨까?" <br>
라는 생각으로 진행하게 되었습니다.

실제 프로젝트 문서나 회의록은 보안 및 데이터 확보 문제로 활용하기 어려웠습니다. <br>
따라서 이러한 구조를 검증하기 위해 시간에 따라 지속적으로 축적되고 검색이 필요한 경제 뉴스를 대체 데이터셋으로 선정했습니다.
